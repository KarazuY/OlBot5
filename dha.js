...
petik = '```'
fake = 'CREATOR BOT\©Riko'//GANTI NAMA KAMU BEP
...
const getPremiumExpired = (sender) => {
		...
		var jamss = ase.getHours();
                         switch(jamss){
                case 0: jamss = "Midnight 🌚"; 
break;
                case 1: jamss = "Midnight 🌚"; 
break;
                case 2: jamss = "Midnight 🌚"; 
break;
                case 3: jamss = "Midnight 🌔"; 
break;
                case 4: jamss = "Midnight 🌔"; 
break;
                case 5: jamss = "Dawn 🌄"; 
break;
                case 6: jamss = "Morning 🌄"; 
break;
                case 7: jamss = "Morning 🌄"; 
break;
                case 8: jamss = "Morning ☀️"; 
break;
                case 9: jamss = "Morning ☀️"; 
break;
                case 10: jamss = "Morning ☀️"; 
break;
                case 11: jamss = "Afternoon 🌞"; 
break;
                case 12: jamss = "Zuhur 🌞"; 
break;
                case 13: jamss = "Afternoon 🌞"; 
break;
                case 14: jamss = "Afternoon 🌞"; 
break;
                case 15: jamss = "Asr 🌞"; 
break;
                case 16: jamss = "Afternoon ☀️"; 
break;
                case 17: jamss = "Evening 🌄"; 
break;
                case 18: jamss = "Maghrib 🌄"; 
break;
                case 19: jamss = "Isha 🌙"; 
break;
                case 20: jamss = "Night 🌙"; 
break;
                case 21: jamss = "Night 🌙"; 
break;
                case 22: jamss = "Midnight 🌙"; 
break;
                case 23: jamss = "Midnight 🌚"; 
break;
            }
...
dha.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
        ...
        menu =`Hai Kak.....\n*${pushname}*\n\`\`\`Saya Olive Bot,SENANG BISA BERTEMU DENGANMU HARI INI\`\`\`
╭─❒ 「 Bot Info 」 ❒
│◦➛NAMA : *Olive Bot*
│◦➛API : @6281317418547
│◦➛OWNER : *©Riko*
...
╭─❒ 「 Developer 」 ❒
│◦➛NAMA : *Riko*
│◦➛OWNER : https://wa.me/6281317418547
│◦➛SUBREK YT : undefined
│◦➛BOT VERSI : 1.0.3
└❏ - Olive Bot
...
│◦➛* ${prefix}panties*
│◦➛* ${prefix}pussy*
│◦➛* ${prefix}nekopoi* _Free trial 3 days_
│◦➛* ${prefix}nekopoisearch* _Free trial 3 days_
│◦➛* ${prefix}nekopoilatest* _Free trial 3 days_
│
├──❲ Image ❳
│◦➛* ${prefix}narutobanner
│◦➛* ${prefix}aesthetic
...
©𝑪𝒓𝒆𝒂𝒕𝒐𝒓 ©Riko`
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: '\`\`\`Mau sewa bot? chat owner\`\`\`', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
©Riko`
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: '\`\`\`MAU SEWA BOT INI? CHAT OWNER\`\`\`', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
//------------------< Downloader/Search/Anime >-------------------
       ...
       case 'soundcloud':
       reply(mess.wait)
       if (isLimit(sender, limitawal, limit)) return reply('Limit lu udh abis')
					        if (isBanned) return reply('Lu udh kena ban')
					        if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
					        if (!isGroup) return reply(mess.only.group);
...
//------------------< Stalk >-------------------
                ...
                reply(mess.wait)
					        ...
					        if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
					        if (!isGroup) return reply(mess.only.group);
                        if (args.length == 0) return reply(`Example: ${prefix + command} Olive`)
                    query = args.join(" ")
                        reply(mess.wait)
...
//------------------<18+ Menu>-----------------------   
       ...
       if (!isPremium) return reply(`Only Prem`)
              ...
              dha.sendMessage(from, '*PERMINTAAN:* '+bokep+'\n*DOSA TANGGUNG PRIBADI*\n*NI BRO FREE BUAT KAMU DOWNLOAD SENDIRI:* '+ kep, text, { quoted: ftoko, caption: `NI BOKEP SAYA DAPAT DARI *©Riko* DOSA TANGGUNG SENDIRI🗿`})
              await limitAdd(sender)
break
...
dha.sendMessage(from, tapib1, document, { quoted: mek, filename:`Olive Bot ~ 404 ${vipi}.mp3`, mimetype: 'audio/application' })
...
break
      ...
      case 'broadcast':
             ...
             for (let _ of anu) {
             dha.sendMessage(_.jid, bc, image, {quoted:freply,caption: `*「 BROADCAST 」*\n\n${body.slice(4)}`})
}
             reply('Suksess broadcast')
             } else {
             for (let _ of anu) {
             sendMess(_.jid, `*「 PESAN SIARAN Olive Bot」*\n\n${body.slice(4)}`)
}
             reply('Suksess broadcast')
}
...
break
              case 'rules':
             reply (`Jangan spam udah itu aja`)
break
       case 'cekmati':
       reply(mess.wait)
					        if (isBanned) return reply('Lu udh kena ban')
...
break
       case 'report':
              ...
              dha.sendMessage('6281317418547@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
...
//------------------< Menunya Bang:v >-------------------
      case 'dana':
             reply(`DANA : undefined\n\n SAYA CUMAN BISA BILANG TERIMAKASIH ATAS KEMURAHAN HATI TUAN TELAH MEMBERIKAN KAMI BANTUAN.SEMOGA ALLAH MEMBALAS APA YG TUAN BERIKAN KE PADA SAYA`)
             
              await limitAdd(sender)
break
           case 'gopay':
             reply(`GOPAY : 08514601932\n\n SAYA CUMAN BISA BILANG TERIMAKASIH ATAS KEMURAHAN HATI TUAN TELAH MEMBERIKAN KAMI BANTUAN.SEMOGA ALLAH MEMBALAS APA YG TUAN BERIKAN KE PADA SAYA`)
             
              await limitAdd(sender)
break  
         case 'pulsa':
             reply(`PULSA : 081317418547\n\n SAYA CUMAN BISA BILANG TERIMAKASIH ATAS KEMURAHAN HATI TUAN TELAH MEMBERIKAN KAMI BANTUAN.SEMOGA ALLAH MEMBALAS APA YG TUAN BERIKAN KE PADA SAYA`)
             
              await limitAdd(sender)
break              
      case 'infoig':
             reply(`Jangan Lupa Follow Ig Owner Ya : https://www.instagram.com/re.oolive`)
             
              await limitAdd(sender)
break
      case 'grupbot':
             reply('https://chat.whatsapp.com/HiKZjoHWn2VICHsZnj0to8')
...
case 'lapor':
					...
					dha.sendMessage('6281317418547@s.whatsapp.net', options, text, {quoted: mek})
